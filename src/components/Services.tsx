import { Baby, User, Sparkles, Brain, Zap } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className={`p-8 rounded-2xl bg-white ${service.hoverBg} transition-all hover:shadow-lg group cursor-default`}
            >
